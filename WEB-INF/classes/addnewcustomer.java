...
public class addnewcustomer extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    Utilities utility = new Utilities(request, pw);
			...
			String product_name = request.getParameter("user_name");
		...
		try
         {  
           response.setContentType("text/html");
			...
			+"<label>Name of the user:<span style='color:#aa0000'>*</span> :</label>"
			+"</div>"
			+"</td>"
			+"<td>"
			+"<div class='shipping-input-fields'>"
			+"<input type='text' name='user_name' class='login-input' style='width:249px; height:24px' required/>"
			+"</div>"
			+"</td>"
			+"</tr>"
			+"<tr>"
