...
public class DealMatchesUtilities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<br> <br>");
		pw.print("<h2  style='padding: 120px'> Always deliver more than expected</h2>");
		pw.print("<br> <br>");
		// pw.print("<h1>We beat our competitors in all aspects. Price-Match Guaranteed</h2>");
			...
			BufferedReader reader = new BufferedReader(new FileReader (new File(TOMCAT_HOME+"\\webapps\\BestDeals\\DealMatches.txt")));
